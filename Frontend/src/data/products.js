...
export const categories = [
  ...
  },
  {
    slug: 'pressing-irons',
    name: 'Pressing Irons',
    blurb: 'Reliable irons for everyday home, laundry, and tailoring use.',
    hero: '/images/new-arrival-hero.svg',
  },
  {
    slug: 'fans',
    name: 'Fans',
    blurb: 'Cooling appliances for homes, shops, offices, and site cabins.',
    hero: '/images/new-arrival-hero.svg',
  },
  {
    slug: 'tv-fridge-guards',
    name: 'TV/Fridge Guards',
    blurb: 'Dedicated appliance guards for TVs, fridges, freezers, and electronics.',
    hero: '/images/Stablizer (1).jpg',
  },
  {
    slug: 'gas-cookers',
    name: 'Gas Cookers',
    blurb: 'Kitchen cooking appliances for home and small commercial use.',
    hero: '/images/new-arrival-hero.svg',
  },
  {
    slug: 'gas-cylinders',
    name: 'Gas Cylinders',
    blurb: 'Cooking gas cylinders and related home energy essentials.',
    hero: '/images/new-arrival-hero.svg',
  },
  {
    slug: 'pipes-trunking',
    name: 'Pipes & Trunking',
    blurb: 'Cable management materials for neat, protected installations.',
    hero: '/images/Copper Cable 2.5mm.jpg',
  },
];
...
const rawProducts = [
  ...
  {
    id: 'p-steam-iron',
    name: 'Steam Pressing Iron',
    category: 'pressing-irons',
    price: 18500,
    oldPrice: 22500,
    rating: 4.6,
    badge: 'Home Essential',
    tags: ['iron', 'appliance', 'home'],
    image: '/images/new-arrival-hero.svg',
    images: ['/images/new-arrival-hero.svg'],
    description: 'Steam pressing iron with smooth glide soleplate for everyday clothing care.',
    specs: {
      Type: 'Steam iron',
      Power: '220-240V',
      Use: 'Home and laundry',
      Feature: 'Adjustable heat control',
    },
  },
  {
    id: 'p-dry-iron',
    name: 'Dry Pressing Iron',
    category: 'pressing-irons',
    price: 12800,
    oldPrice: 15500,
    rating: 4.4,
    badge: 'Affordable',
    tags: ['iron', 'laundry', 'home'],
    image: '/images/new-arrival-hero.svg',
    images: ['/images/new-arrival-hero.svg'],
    description: 'Simple dry iron for quick pressing at home, shops, and tailoring corners.',
    specs: {
      Type: 'Dry iron',
      Soleplate: 'Non-stick finish',
      Use: 'Clothes pressing',
  ...
  },
  {
    ...
    rating: 4.7,
    badge: 'Cooling',
    tags: ['fan', 'cooling', 'home'],
    image: '/images/new-arrival-hero.svg',
    images: ['/images/new-arrival-hero.svg'],
    description: 'Adjustable standing fan with steady airflow for rooms, shops, and offices.',
    specs: {
      Size: '16 inch',
  ...
  },
  {
    ...
    rating: 4.6,
    badge: 'Installer Pick',
    tags: ['fan', 'ceiling', 'cooling'],
    image: '/images/new-arrival-hero.svg',
    images: ['/images/new-arrival-hero.svg'],
    description: 'Durable ceiling fan for bedrooms, shops, living rooms, and office spaces.',
    specs: {
      Blades: '3 blades',
      Speed: 'Regulator controlled',
      Use: 'Room ventilation',
      Voltage: '220-240V',
    },
  },
  {
    id: 'p-tv-guard',
    name: 'TV Guard Protector',
    category: 'tv-fridge-guards',
    price: 9800,
    oldPrice: 12500,
    rating: 4.5,
    badge: 'Protection',
    tags: ['tv', 'guard', 'protection'],
    image: '/images/Stablizer (1).jpg',
    images: ['/images/Stablizer (1).jpg'],
    description: 'Compact guard that protects TVs and electronics from unstable voltage supply.',
    specs: {
      Use: 'TV and electronics',
  ...
  },
  {
    ...
    rating: 4.6,
    badge: 'Kitchen',
    tags: ['gas', 'cooker', 'kitchen'],
    image: '/images/new-arrival-hero.svg',
    images: ['/images/new-arrival-hero.svg'],
    description: 'Two-burner gas cooker for compact kitchens, students, and small families.',
    specs: {
      Burners: '2 burners',
      Ignition: 'Manual',
      Use: 'Home cooking',
      Finish: 'Easy-clean top',
    },
  },
  {
    id: 'p-gas-cylinder-125kg',
    name: 'Gas Cylinder 12.5kg',
    category: 'gas-cylinders',
    price: 48500,
    oldPrice: 55000,
    rating: 4.5,
    badge: 'Kitchen',
    tags: ['gas', 'cylinder', 'cooking'],
    image: '/images/new-arrival-hero.svg',
    images: ['/images/new-arrival-hero.svg'],
    description: '12.5kg cooking gas cylinder for steady home and small business use.',
    specs: {
      Capacity: '12.5kg',
      Use: 'Cooking gas',
  ...
  },
  {
    ...
    category: 'pipes-trunking',
    price: 4200,
    oldPrice: 5200,
    rating: 4.4,
    badge: 'Installation',
    tags: ['trunking', 'pipe', 'installation'],
    image: '/images/Copper Cable 2.5mm.jpg',
    images: ['/images/Copper Cable 2.5mm.jpg'],
    description: 'PVC trunking for tidy surface wiring and cable protection.',
    specs: {
      Material: 'PVC',
  ...
  },
  {
    ...
    rating: 4.3,
    badge: 'Installation',
    tags: ['pipe', 'conduit', 'wiring'],
    image: '/images/Copper Cable 2.5mm.jpg',
    images: ['/images/Copper Cable 2.5mm.jpg'],
    description: 'Electrical conduit pipe for protected cable runs in building installations.',
    specs: {
      Type: 'Conduit pipe',
      Material: 'PVC',
...
export const groupedProducts = {
  ...
  pressingIrons: products.filter((product) => product.category === 'pressing-irons'),
  fans: products.filter((product) => product.category === 'fans'),
  tvFridgeGuards: products.filter((product) => product.category === 'tv-fridge-guards'),
  gasCookers: products.filter((product) => product.category === 'gas-cookers'),
  gasCylinders: products.filter((product) => product.category === 'gas-cylinders'),
  pipesTrunking: products.filter((product) => product.category === 'pipes-trunking'),
};
