...
export default function AuthModal({ auth }) {
  ...
  const submit = async (event) => {
    ...
    try {
      ...
      if (/already registered|already has an account/i.test(error.message || '')) {
